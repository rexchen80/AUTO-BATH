...
public class UDP_withIK_rotation : MonoBehaviour
{
    public const string SERVER_IP = "30.201.208.49";  // 默认本地服务器IP
    ...
    // 手动控制8号关节的角度（左手第8个关节，索引为7）
    [Range(-180f, 180f)]
    public float manualJoint8Angle = 0f;           // 手动输入的8号关节角度
    ...
    private void Update()
    {
        ...
        try
        {
            ...
            // 覆盖8号关节的角度值（左手第8个关节，索引为7）
            angles[7] = manualJoint8Angle;
